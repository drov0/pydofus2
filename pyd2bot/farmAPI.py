...
class FarmAPI:
    ...
    def harvest(self):
        ...
        roleplayInteractivesFrame: RoleplayInteractivesFrame = (
            krnl.Kernel().getWorker().getFrame(RoleplayInteractivesFrame)
        )
        ...
        for ie in roleplayEntitiesFrame.interactiveElements:
            ...
            if enabledSkill is not None:
                ie = roleplayInteractivesFrame.getInteractiveElement(ie.elementId)
                roleplayInteractivesFrame.skillClicked(ie, enabledSkill)
                if enabledSkill is not None:
