...
class HouseInstanceInformations(NetworkMessage):
    ...
    def init(self, instanceId_:int, ownerTag_:'AccountTagInformation', price_:int, secondHand_:bool, isLocked_:bool, hasOwner_:bool, isSaleLocked_:bool, isAdminLocked_:bool):
