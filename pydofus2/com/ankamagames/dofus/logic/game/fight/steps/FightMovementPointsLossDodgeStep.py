...
from com.ankamagames.dofus.logic.game.fight.steps.abstract.AbstractDodgePointLossStep import AbstractDodgePointLossStep
...
class FightMovementPointsLossDodgeStep(AbstractDodgePointLossStep, IFightStep):
    ...
    def start(self) -> None:
        FightEventsHelper.sendFightEvent(FightEventEnum.FIGHTER_MP_LOSS_DODGED, [self.fighterId, self._amount], self._fighterId, self.castingSpellId)
