package com.ankamagames.dofus.network.types.game.guild
{
    ...
    public class GuildRankInformation extends GuildRankMinimalInformation implements INetworkType
    {
        
        public static const protocolId:uint = 4621;
        ...
        public function GuildRankInformation()
        {
        ...
        public function initGuildRankInformation(id:uint = 0, name:String = "", order:uint = 0, gfxId:uint = 0, modifiable:Boolean = false, rights:Vector.<uint> = null) : GuildRankInformation
        {
        ...
        public function serializeAs_GuildRankInformation(output:ICustomDataOutput) : void
        {
        ...
        public function deserializeAs_GuildRankInformation(input:ICustomDataInput) : void
        {
            var _val4:uint = 0;
        ...
        public function deserializeAsyncAs_GuildRankInformation(tree:FuncTree) : void
        {
        ...
        private function _orderFunc(input:ICustomDataInput) : void
        {
            ...
            if(this.order < 0)
            {
                throw new Error("Forbidden value (" + this.order + ") on element of GuildRankInformation.order.");
            }
        }
        ...
        private function _gfxIdFunc(input:ICustomDataInput) : void
        {
            ...
            if(this.gfxId < 0)
            {
                throw new Error("Forbidden value (" + this.gfxId + ") on element of GuildRankInformation.gfxId.");
            }
        }
