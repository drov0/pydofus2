...
class MovementPath:
    ...
    MOUNT_WALK_HORIZONTAL_DIAG_DURATION_MEAN = 0.38876421137270406
    MOUNT_WALK_HORIZONTAL_DIAG_DURATION_VAR = 8.586667350942973e-05

    MOUNT_WALK_VERTICAL_DIAG_DURATION_MEAN = 0.31451364896989403
    MOUNT_WALK_VERTICAL_DIAG_DURATION_VAR = 0.00011395973650102993

    MOUNT_WALK_LINEAR_DURATION_MEAN = 0.33892126546192525
    MOUNT_WALK_LINEAR_DURATION_VAR = 1.4302197711789372e-05

    MOUNT_RUN_HORIZONTAL_DIAG_DURATION_MEAN = 0.16197434077870645
    MOUNT_RUN_HORIZONTAL_DIAG_DURATION_VAR = 0.00011671692381711785

    MOUNT_RUN_VERTICAL_DIAG_DURATION_MEAN = 0.1395933731512491
    MOUNT_RUN_VERTICAL_DIAG_DURATION_VAR = 0.0001505968177380751

    MOUNT_RUN_LINEAR_DURATION_MEAN = 0.13764700616039238
    MOUNT_RUN_LINEAR_DURATION_VAR = 4.846858720173789e-05
